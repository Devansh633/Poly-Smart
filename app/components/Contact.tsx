        ...
        <div>
          ...
          <div className='flex pb-6 pt-[3rem] items-center'>
            <div className='rounded-full bg-[#F7F9FF] p-[0.5rem] w-[3rem] h-[3rem] md:w-[4rem] md:h-[4rem] flex items-center justify-center min-h-[3rem] min-w-[3rem] md:min-h-[4rem] md:min-w-[4rem]'>
              <img src="https://drive.google.com/uc?id=1j12ZO5dRpRY5BLLg5pOps6dxJVzVefXJ" className='w-[70%] h-[70%]' />
            </div>
          ...
          <div className='flex py-6 items-center'>
            <div className='rounded-full bg-[#F7F9FF] p-[0.5rem] w-[3rem] h-[3rem] md:w-[4rem] md:h-[4rem] flex items-center justify-center min-h-[3rem] min-w-[3rem] md:min-h-[4rem] md:min-w-[4rem]'>
              <img src="https://drive.google.com/uc?id=11K7oLAhtEyqkBMYksdNRuOU2ZfQv4C4r" className='w-[70%] h-[70%]' />
            </div>
            <p className="text-base md:text-xl text-[#F7F9FF] ml-4 flex items-center">
          ...
          <div className='flex py-6 items-center'>
            <div className='rounded-full bg-[#F7F9FF] p-[0.5rem] w-[3rem] h-[3rem] md:w-[4rem] md:h-[4rem] flex items-center justify-center min-h-[3rem] min-w-[3rem] md:min-h-[4rem] md:min-w-[4rem]'>
              <img src="https://drive.google.com/uc?id=1pLIqCsMUTwhoC-D5S_Umk6gTyW34cD4h" className='w-[70%]l h-[70%]' />
            </div>
            <p className="text-base md:text-xl text-[#F7F9FF] ml-4 flex items-center">
